...
expName = 'Task3_VisualSearch'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\PRANJAL\\Desktop\\PSY310\\Task3_VisualSearch\\Task3_VisualSearch_lastrun.py',

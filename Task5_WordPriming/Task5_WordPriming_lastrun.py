...
expName = 'Task5_WordPriming'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\PRANJAL\\Desktop\\PSY310\\Task5_WordPriming\\Task5_WordPriming_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisTrial_2 in trials_2:
        ...
        # keep track of which components have finished
        testingComponents = [text_2, textbox, text_3, mouse]

...
expName = 'Task4_MotorSequence'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\PRANJAL\\Desktop\\PSY310\\Task4_MotorSequence\\Task4_MotorSequence_lastrun.py',
